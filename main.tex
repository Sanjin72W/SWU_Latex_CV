...
\definecolor{primary_color}{RGB}{0, 80, 158}    % 松针绿
\definecolor{secondary_color}{RGB}{0, 80, 158} % 金陵黄
...
% 学院
\newcommand{\school}{计信院|Faculty of Computer and Information Science} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@nbu.edu.cn}{ziyaotang03@outlook.com}
        \hspace{4em}
        % 手机号
        \faPhone \quad  151-9810-9628
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
        \faGithub \quad \href{http://cis.swu.edu.cn/}{GitHub 项目地址}
    }
}
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/swu_logo.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.3] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/swu_logo_bg.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{西南大学}}，专科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{西南大学}}，本科 \hfill 2010年9月--2020年6月
        \begin{itemize}
            \item 你的学院，你的专业
            \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
        ...
        \vspace{0.5em}
        {\large \textbf{西南大学}}，硕士 \hfill 2020年9月--至今
        \begin{itemize}
